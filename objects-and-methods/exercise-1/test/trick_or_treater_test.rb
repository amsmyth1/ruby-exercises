...
class TrickOrTreaterTest < Minitest::Test
  ...
  def test_gets_candies
    ...
    trick_or_treater.gets(Candy.new("Gummy bears"))
  ...
  def test_eats_candies
    ...
    trick_or_treater.gets(Candy.new("Gummy worms"))
    trick_or_treater.gets(Candy.new("Liquorice"))
    trick_or_treater.gets(Candy.new("Salty Serpents"))
