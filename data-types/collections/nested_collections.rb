...
class NestesdCollectionsTest < Minitest::Test
  ...
  def test_3
    ...
    coordinates[coordinates.index([3, 46])] = [6, 55]
  ...
  def test_4
    ...
    # to 0
    coordinates[coordinates.index([3, 46])] = [3, 0]
  ...
  def test_19
    ...
    actual = three_day_forecast[:days][0][:high] = 99
  ...
  def test_20
    ...
    # team[:coaches] = []
    actual = three_day_forecast["time"] = "12:30"
